-- ACLARACION 
-- LOS PRIMEROS INSERTS SON PROPIOS DEL SISTEMA Y SE REQUIEREN PARA SU USO
-- LOS INSERTS DE LUGARES CORRESPONDE A LA DISTRIBUCION DE COSTA RICA
-- SE HACE DE ESTA MANERA DEBIDO A QUE EL MOTOR UTILIZADO EN LA BASE DE DATOS 
-- NO LOGRABA CARGAR LOS ARCHIVOS .TXT QUE SE REQUERIAN Y ME BUSQUE OTRA SOLUCION.
INSERT INTO tipo_telefonos (nombre)
VALUES('Celular');
INSERT INTO tipo_telefonos (nombre)
VALUES('Casa');
...
INSERT INTO canton (codigo_canton, codigo_provincia, nombre_canton) VALUES 
 (101,1,'San José'),
 (102,1,'Escazú'),
 (103,1,'Desamparados'),
 (104,1,'Puriscal'),
